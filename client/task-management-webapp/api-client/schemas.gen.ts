...
export const BoardMemberDtoSchema = {
  type: "object",
  properties: {
    id: {
      type: "integer",
    ...
    role: {
      $ref: "#/components/schemas/BoardMemberRole",
    },
    joinedDate: {
      type: "string",
      format: "date-time",
...
export const BoardMemberRoleSchema = {
  enum: [0, 1],
  type: "integer",
  format: "int32",
} as const;
...
export const ChecklistDtoSchema = {
  required: ["title"],
  type: "object",
  properties: {
    id: {
...
export const ChecklistItemDtoSchema = {
  required: ["content"],
  type: "object",
  properties: {
    id: {
