...
const Settings = () => {
	...
	const [userData, setUserData] = useState<UserDtoReadable | undefined>(
		undefined
	);
			...
			try {
				...
				if (response.data?.profilePhotoPath) {
					try {
						...
						const photoResponse =
							await UserProfileService.getApiUserProfileProfilePhoto(
								{
						...
						<div className="pt-20 px-8 pb-8">
							...
							<form onSubmit={handleProfileSubmit}>
								<p className="text-sm text-gray-500 dark:text-gray-400 mt-3 text-center mb-8">
									Click on the avatar to upload a profile
									picture
									<br />
							...
							<div className="space-y-6">
								...
								{passwordData.newPassword && (
									<PasswordStrengthMeter
										...
										onScoreChange={setPasswordStrength}
									/>
								)}
							...
							<div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-8 text-center">
								<div className="flex flex-col items-center space-y-4">
									...
									<p className="text-gray-600 dark:text-gray-400 max-w-md">
										We're working on additional preference
